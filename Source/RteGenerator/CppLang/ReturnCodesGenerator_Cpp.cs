...
namespace AutosarGuiEditor.Source.RteGenerator.CppLang
{
    public class ReturnCodesGenerator_Cpp
    {
        public void GenerateReturnCodesFile(String folder)
        {
            ...
            writer.WriteLine(RteFunctionsGenerator_Cpp.CreateDefine("RTE_E_OK", "0u"));
            writer.WriteLine(RteFunctionsGenerator_Cpp.CreateDefine("RTE_E_INVALID", "1u"));
            writer.WriteLine(RteFunctionsGenerator_Cpp.CreateDefine("RTE_E_LOST_DATA", "64u"));
            writer.WriteLine(RteFunctionsGenerator_Cpp.CreateDefine("RTE_E_NO_DATA", "131u"));
            writer.WriteLine(RteFunctionsGenerator_Cpp.CreateDefine("RTE_E_UNCONNECTED", "134u"));
            writer.WriteLine(RteFunctionsGenerator_Cpp.CreateDefine("RTE_E_OUT_OF_RANGE", "137u"));
            writer.WriteLine(RteFunctionsGenerator_Cpp.CreateDefine("RTE_E_LIMIT", "138u"));
